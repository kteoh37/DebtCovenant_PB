...
* remove [1em]
filefilter "$outdir/regression_violation_`i'_`file'_adj2.tex" "$outdir/regression_violation_`i'_`file'_adj3.tex", ///
	from( ///
"[1em]" ///
	) to( ///
	"" /// 
...
erase "$outdir/regression_violation_`i'_`file'_adj2.tex"
shell mv "$outdir/regression_violation_`i'_`file'_adj3.tex" "$outdir/regression_violation_`i'_`file'.tex"
